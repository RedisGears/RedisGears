...
When upgrading the trigger code (using the `REPLACE` option of [`TFUNCTION LOAD`](commands.md#tfunction-load) command) all the trigger parameters can be modified.
