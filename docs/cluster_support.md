...
Triggers and Functions support cross-shard operation in a Redis cluster. This means that it is possible to call a function that will be invoked on another shard. We call such a function a remote function.
