...
#define REDISLAMBDA_MODULE_INIT_FUNCTION(name, ctx) \
...
static bool RedisGears_Initialize(RedisModuleCtx* ctx){
    REDISLAMBDA_MODULE_INIT_FUNCTION(CreateType, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(BWWriteLong, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(BWWriteString, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(BWWriteBuffer, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(BRReadLong, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(BRReadString, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(BRReadBuffer, ctx);

    REDISLAMBDA_MODULE_INIT_FUNCTION(RegisterReader, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(RegisterForEach, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(RegisterAccumulator, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(RegisterMap, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(RegisterFilter, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(RegisterGroupByExtractor, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(RegisterReducer, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(CreateCtx, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(Map, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(Accumulate, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(Filter, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(Run, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(Register, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(ForEach, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(GroupBy, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(Collect, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(Repartition, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(FlatMap, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(Limit, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(FreeFlatExecution, ctx);

    REDISLAMBDA_MODULE_INIT_FUNCTION(GetExecution, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(IsDone, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(GetRecordsLen, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(GetRecord, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(RegisterExecutionDoneCallback, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(GetPrivateData, ctx);
	REDISLAMBDA_MODULE_INIT_FUNCTION(SetPrivateData, ctx);
	REDISLAMBDA_MODULE_INIT_FUNCTION(DropExecution, ctx);
	REDISLAMBDA_MODULE_INIT_FUNCTION(GetId, ctx);

    REDISLAMBDA_MODULE_INIT_FUNCTION(FreeRecord, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(RecordGetType, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(KeyRecordCreate, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(KeyRecordSetKey, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(KeyRecordSetVal, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(KeyRecordGetVal, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(KeyRecordGetKey, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(ListRecordCreate, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(ListRecordLen, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(ListRecordAdd, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(ListRecordGet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(ListRecordPop, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(StringRecordCreate, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(StringRecordGet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(StringRecordSet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(DoubleRecordCreate, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(DoubleRecordGet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(DoubleRecordSet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(LongRecordCreate, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(LongRecordGet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(LongRecordSet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(KeyHandlerRecordCreate, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(KeyHandlerRecordGet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(HashSetRecordCreate, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(HashSetRecordSet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(HashSetRecordGet, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(HashSetRecordGetAllKeys, ctx);
    REDISLAMBDA_MODULE_INIT_FUNCTION(HashSetRecordFreeKeysArray, ctx);
