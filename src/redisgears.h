 ...
 */
GEARS_API FlatExecutionPlan* MODULE_API_FUNC(RedisGears_CreateCtx)(char* readerName);
...
GEARS_API int MODULE_API_FUNC(RedisGears_Register)(FlatExecutionPlan* fep, ExecutionMode mode, void* arg, char** err);
