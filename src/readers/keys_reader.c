...
static int RG_KeysReaderCtxSerialize(ExecutionPlan* ep,void* ctx, Gears_BufferWriter* bw, char** err){
...
static int RG_KeysReaderCtxDeserialize(ExecutionPlan* ep, void* ctx, Gears_BufferReader* br, char** err){
    KeysReaderCtx* krctx = (KeysReaderCtx*)ctx;
